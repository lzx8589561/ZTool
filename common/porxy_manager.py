...
# 初始化InternetSetOption win32系统api相关属性
...
CONNECTIONS = winreg.OpenKey(
    winreg.HKEY_CURRENT_USER, CONN_PATH, 0, winreg.KEY_ALL_ACCESS)
...
def set_proxy_auto(proxy_addr, conn_name='DefaultConnectionSettings'):
    ...
    InternetSetOption(
        None, INTERNET_OPTION_PER_CONNECTION_OPTION, byref(List), nSize)
